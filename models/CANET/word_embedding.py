...
def load_word_embeddings(vocab, cfg):
    if cfg.emb_type == 'glove':
        embeds = load_glove_embeddings(vocab, cfg.word_embedding_root)
...
def load_glove_embeddings(vocab, root):
    '''
    Inputs
    ...
    '''
    vocab = [v.lower() for v in vocab]
    emb_file = root+'/glove/glove.6B.300d.txt'
