...
if __name__ == "__main__":
    ...
    init_att = model.soft_att
    init_obj = model.soft_obj_fix

    model.load_state_dict(torch.load(config.load_model))
    final_att = model.soft_att_obj['att']
    final_obj = model.soft_att_obj['obj']

    dist_att = final_att.cpu() - init_att.cpu()
    dist_obj = final_obj.cpu() - init_obj.cpu()
